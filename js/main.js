...
import { loadPDF, loadImg, exportData, importData, printView } from './io.js';
...
async function onFileChange(e) {
  ...
  } catch (err) { alert('Impossible de charger : ' + err.message); return; }
...
function startMeasuring() {
  ...
  setInstructions('Cliquez sur le 1er point de la mesure');
}
